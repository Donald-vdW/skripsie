...
function Aedes (opts) {
  ...
  if (opts.VAST === true) {
    ...
    let VASTopts = {
      ...
      // if opts.VASTGatewayHost is not specified then set to the default value as "0.0.0.0"
      GW_host : opts.VASTGatewayHost !== undefined ? opts.VASTGatewayHost : "0.0.0.0",
      GW_port : opts.VASTport,
      broker : this,
      
      // Debugging opts: If not specified then set to the default values as in the matcher.js file
      logRecordLevel : opts.VASTLogRecordLevel !== undefined ? opts.VASTLogRecordLevel : 0,
      eventRecordLevel : opts.VASTEventRecordLevel !== undefined ? opts.VASTEventRecordLevel : 0,
      logDisplayLevel : opts.VASTLogDisplayLevel !== undefined ? opts.VASTLogDisplayLevel : 3,
      eventDisplayLevel : opts.VASTEventDisplayLevel !== undefined ? opts.VASTEventDisplayLevel : 0
    }
...
Aedes.prototype.publish = function (packet, client, done) {
  // console.log('Aedes prototype publish')
  // console.log(packet)
  // console.log(client)
  // console.log(done)
